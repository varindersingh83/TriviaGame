...
var questionSet = [
    ...
    correctAnswer : '400',
    blurb : `According to the World Canine Organization FCI (Fédération Cynologique Internationale), there are approximately 400 recognized breeds of dog worldwide. There is some contention, however, as to the exact number of dog breeds as various kennel clubs recognize different breeds. In addition, all "purebreds" are, in reality,derived from mixed-breed dog populations, complicating the issue further.`  
    },
    {
    ...
    blurb :`Basset Hounds are generally considered to be the breed of dog with the longest ears. According to the Guinness Book of World Records, a Basset Hound from Germany named Jack holds the record for longest ears on a dog. Jack's ears measure a remarkable 13 inches and are so long that he sometimes trips over them when he walks.`
    } ,
    {
    ...
    blurb :`All modern dogs are generally believed to be descended from Tomarctus, a stealthy predator that roamed the plains and grasslands of North America approximately ten to fifteen million years ago. Wolves, jackals, and coyotes are also believed to be descendants of Tomarctus.`
    }] 
